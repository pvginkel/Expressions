...
namespace Expressions.Test.VisualBasicLanguage.Compilation
{
    ...
    internal class MethodCalls : TestBase
    {
        ...
        public void ParamsWithNullArg()
        {
            ...
            Resolve(context, "Owner.Params(0, nothing)", -1);
        }
        ...
        public void ObjectParamsWithNullArg()
        {
            ...
            Resolve(context, "Owner.ObjectParams(0, nothing)", -1);
        }
        ...
        {
            new DynamicExpression(expression, ExpressionLanguage.VisualBasic).Invoke(expressionContext);
        }
